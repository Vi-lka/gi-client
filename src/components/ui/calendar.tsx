  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "animate-fade-in w-full relative p-0 text-center md:text-base text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-outside)]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-xl",
          props.mode === "range"
