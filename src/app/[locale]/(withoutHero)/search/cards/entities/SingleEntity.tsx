...
export default function SingleEntity({
  ...
  return (
    <Card key={"edu_program" + data.__typename + Math.random().toString()} className='min-w-0 h-full group/card border-transparent dark:border-border/20 dark:hover:border-border hover:shadow-lg shadow-md rounded-3xl transition duration-300'>
